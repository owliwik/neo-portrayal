...
import { RealNamePopup } from './real-name-popup'
...
export const Navigation = () => {
  ...
  return (
    <div className=''>
      <RealNamePopup isOpen={realNameOpen} setOpen={setRealNameOpen} />
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  pathName === item.href &&
                    'text-primary-foreground bg-primary-1'
                )}
              >
                {item.name}
              </Link>
                  ...
                  <Avatar className='cursor-pointer'>
                    ...
                    <AvatarFallback>
                      {userProfile.profile?.last ??
                        userProfile.user.user_metadata['display_name'][0]}
                    </AvatarFallback>
                  </Avatar>
                </HoverCardTrigger>
                  ...
                  <div className='m-2'>
                    ...
                    <span className='font-bold'>
                      ...
                      userProfile.profile.first ? (
                        ...
                        <span>{` ${userProfile.user.user_metadata['display_name']} `}</span>
                      )}
                    </span>
                    的身份登入
                  </div>
      ...
      <div>
        {userProfile?.user &&
          !(
            userProfile?.profile &&
            userProfile.profile.student_id &&
            userProfile.profile.first &&
            userProfile.profile.last &&
